...
3. Insert **Beat Equalizer**. В шапке должно быть `8 in / 8 out`. Осциллограф на строке — выход после delay/invert; атаки должны совпасть по времени. Синий след, красный = клип.
