...
3. Insert **Beat Equalizer**. Заголовок `Beat Equalizer  |  scope`. Если колонка называется `In` или осциллограф в строке канала — старый бинарник: **Cmd+Q**, вставить снова. Сверху компактная таблица On / Ch / Delay / Polarity. Снизу стек осциллографов на общую ось (циан; красный = клип). **Time** — длина окна в мс (5…200). Без playback: `play to see waveform`. Атаки разных каналов должны совпасть по времени.
