...
// Равноамплитудная склейка перед следующей защищённой атакой. Дефолт внутри
// диапазона 2–5 мс из плана нарезки; если бюджета меньше, план это покажет.
inline constexpr float kEditCrossfadeMs = 3.0f;
